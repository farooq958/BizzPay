  ...
  handelNavigation(BuildContext? context, String navigateTo, var info,
    ...
    if (context != null) {
      ...
      switch (navigateTo) {
        ...
        case "BADGE_REQUESTED_USER":
          _navigate(context, const BadgesRequestScreen());
        case "BADGE_REQUESTED_EXPERT":
          _navigate(context, const BadgesRequestScreen());
        case "BADGE_DELIVERY_REJECTED":
          _navigate(context, const RequestsScreen());
        case "BADGE_DELIVERY_ACCEPTED":
          _navigate(context, const RequestsScreen());
        case "BUSINESS_BOOSTED":
          _navigate(
              context,
              BusinessDetails(
                id: info,
              ));
        case "BADGE_DELIVERED_EXPERT":
          _navigate(context, const RequestsScreen());
        case " BADGE_DELIVERED_USER":
          _navigate(context, const BadgesRequestScreen());
        default:
