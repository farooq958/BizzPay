...
import 'package:buysellbiz/Presentation/Widgets/Dashboard/Chat/Components/report_user.dart';
    ...
    return PopupMenuButton(
      ...
      onSelected: (value) async {
        ...
        if (value == MenuItem1.block) {
          var data = {
            "isBlocked":
                InboxControllers.blockedStatus.value == true ? false : true,
            "blockedBy": Data().user?.user?.id,
            "blockedTo": InboxControllers.chatDetailData.value.receiver
                .toString()
                .trim(),
        ...
        if (value == MenuItem1.report) {
          Navigate.to(
              context,
              ReportChatUser(
                  userID: InboxControllers.chatDetailData.value.receiver
                      .toString()
                      .trim()));
          // ///logic for edit
        }
