...
class TermsAndConditions extends StatelessWidget {
  ...
  final List<PrivacyAndTermsModel> data = [
    PrivacyAndTermsModel(
      description:
          'Please read these terms and conditions carefully before using the "BizPay" mobile application.',
    ),

    PrivacyAndTermsModel(
        title: '1. Acceptance of Terms:',
        description:
            'By accessing or using the "BizPay" app, you agree to be bound by these terms and conditions.'),
    PrivacyAndTermsModel(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView.separated(
            ...
            itemBuilder: (context, index) => TermsAndPrivacyTextTile(
                  data: data[index],
                )));
  }
}
