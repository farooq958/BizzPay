                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            const Spacer(),
                            CustomPopupMenu(onClick: (action) async {
                              print(action);
                              ...
                              if (action == 'edit') {
                                ...
                                String businessLink =
                                    "https://bizzpayapp.com?${businessProducts![index!].id}";
                                await Share.share(businessLink);
                                // await DynamicLinksProvider.createBusinessLink(
                                //         false,
                                //         businessProducts![index!].id ?? '')
                                //     .then((value) async {
                                // });
                        ...
                        Row(
                          children: [
                            AppText(
                                "\$${Utils.formatPrice(businessProducts![index!].salePrice!)}",
